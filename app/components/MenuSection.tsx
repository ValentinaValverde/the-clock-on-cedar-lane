    ...
    <div className="w-full bg-dark-green flex flex-col items-center justify-center">
      <div className="w-2/3 py-24 flex flex-col items-center" id="menu">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-light-green">
          <div className="border border-light-green border-dashed border-dashed p-8 rounded-xl overflow-hidden">
          ...
          <div className="border border-light-green border-dashed p-8 rounded-xl overflow-hidden">
          ...
          <div className="border border-light-green border-dashed p-8 rounded-xl overflow-hidden text-center">
